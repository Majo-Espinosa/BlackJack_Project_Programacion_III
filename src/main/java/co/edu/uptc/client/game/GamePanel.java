<<<<<<<< HEAD:src/main/java/co/edu/uptc/view/game/GamePanel.java
package co.edu.uptc.view.game;
========
package co.edu.uptc.client.game;
>>>>>>>> origin/Daniel-otra-vez:src/main/java/co/edu/uptc/client/game/GamePanel.java
...
import co.edu.uptc.client.game.crupier.CrupierPanel;
import co.edu.uptc.client.game.draw.RoundedBorder;
import co.edu.uptc.client.game.players.BottomPanel;
import co.edu.uptc.client.game.players.CenterPanel;
