<<<<<<<< HEAD:src/main/java/co/edu/uptc/view/reusable/ImageButton.java
package co.edu.uptc.view.reusable;
========
package co.edu.uptc.client.reusable;
>>>>>>>> origin/Daniel-otra-vez:src/main/java/co/edu/uptc/client/reusable/ImageButton.java
