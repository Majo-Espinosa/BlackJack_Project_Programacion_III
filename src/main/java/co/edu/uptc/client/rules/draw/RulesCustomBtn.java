...
<<<<<<<< HEAD:src/main/java/co/edu/uptc/view/rules/draw/RulesCustomBtn.java
package co.edu.uptc.view.rules.draw;
========
package co.edu.uptc.client.rules.draw;
>>>>>>>> origin/Daniel-otra-vez:src/main/java/co/edu/uptc/client/rules/draw/RulesCustomBtn.java
