<<<<<<<< HEAD:src/main/java/co/edu/uptc/view/rules/RulesPanel.java
package co.edu.uptc.view.rules;
========
package co.edu.uptc.client.rules;
>>>>>>>> origin/Daniel-otra-vez:src/main/java/co/edu/uptc/client/rules/RulesPanel.java
...
========
import co.edu.uptc.client.rules.draw.RulesCustomBtn;
>>>>>>>> origin/Daniel-otra-vez:src/main/java/co/edu/uptc/client/rules/RulesPanel.java
