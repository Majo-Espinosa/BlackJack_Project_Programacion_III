...
<<<<<<<< HEAD:src/main/java/co/edu/uptc/view/popups/draw/OutlinedLabel.java
package co.edu.uptc.view.popups.draw;
========
package co.edu.uptc.client.popups.draw;
>>>>>>>> origin/Daniel-otra-vez:src/main/java/co/edu/uptc/client/popups/draw/OutlinedLabel.java
